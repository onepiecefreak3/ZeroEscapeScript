...
using Logic.Business.SpikeChunsoftScriptManagement;
using Logic.Domain.CodeAnalysisManagement;
using Logic.Domain.SpikeChunsoftManagement;

namespace Mappings.ZeroEscapeScript;
...
public class KernelInitializer : IKernelInitializer
{
    ...
    {
        // Add own components
        kernel.RegisterComponent<SpikeChunsoftScriptManagementActivator>();
        kernel.RegisterComponent<SpikeChunsoftManagementActivator>();
