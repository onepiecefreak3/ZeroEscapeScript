...
public class MethodDeclarationParametersSyntax : SyntaxNode
{
    ...
    public CommaSeparatedSyntaxList<LiteralExpressionSyntax>? Parameters { get; private set; }
    ...
    public MethodDeclarationParametersSyntax(SyntaxToken parenOpen, CommaSeparatedSyntaxList<LiteralExpressionSyntax>? parameters, SyntaxToken parenClose)
    {
    ...
    public void SetParameters(CommaSeparatedSyntaxList<LiteralExpressionSyntax>? parameters, bool updatePosition = true)
    {
        if (parameters != null)
            parameters.Parent = this;
