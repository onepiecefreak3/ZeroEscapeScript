...
public class IfNotStatementSyntax : StatementSyntax
{
    ...
    public IfNotStatementSyntax(SyntaxToken ifToken, SyntaxToken notToken, SyntaxToken parenOpen, LiteralExpressionSyntax condition,
        SyntaxToken parenClose, BlockExpression body)
    {
        ifToken.Parent = this;
